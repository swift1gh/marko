  ...
  const contactInfo = [
    {
      ...
      title: "Email",
      content: "support@marko.com",
      link: "mailto:support@marko.com",
    },
    {
      ...
      <div className="relative bg-purple-800">
        <div className="absolute inset-0">
          <img
            ...
            src="https://images.unsplash.com/photo-1486406146923-c4336f7c90f9?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=1950&q=80"
            alt="Contact us"
          />
              ...
              {contactInfo.map((info, index) => (
                <div key={index} className="flex items-start">
                  ...
                  <div className="ml-4">
                    ...
                    <a
                      href={info.link}
                      className="mt-1 text-base text-gray-500 hover:text-purple-600">
                      {info.content}
                    </a>
                  </div>
                </div>
      ...
      <div className="bg-gray-50">
        <div className="max-w-7xl mx-auto py-16 px-4 sm:px-6 lg:px-8">
          <div className="aspect-w-16 aspect-h-9">
            <iframe
              src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d387193.30591910525!2d-74.25986532934461!3d40.69714941912341!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x89c24fa5d33f083b%3A0xc80b8f06e177fe62!2sNew%20York%2C%20NY%2C%20USA!5e0!3m2!1sen!2s!4v1641234567890!5m2!1sen!2s"
              width="100%"
              height="450"
              style={{ border: 0 }}
              allowFullScreen=""
